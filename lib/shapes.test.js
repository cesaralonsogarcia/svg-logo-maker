    ...
    describe('render', () => {
        it('should render a blue square logo', () => {
            const innerHtml = `<svg version="1.1"
                            ...
                            <text x="150" y="175" font-size="80" text-anchor="middle" fill="white">TXT</text>
                            </svg>`;
    ...
    describe('render', () => {
        it('should render a green circle logo', () => {
            const innerHtml = `<svg version="1.1"
                            ...
                            <text x="150" y="125" font-size="80" text-anchor="middle" fill="white">TXT</text>
                            </svg>`;
    ...
    describe('render', () => {
        it('should render a red triangle logo', () => {
            const innerHtml = `<svg version="1.1"
                            ...
                            <text x="120" y="145" font-size="80" text-anchor="middle" fill="white">TXT</text>
                            </svg>`;
