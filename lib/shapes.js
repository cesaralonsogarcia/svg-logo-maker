...
class Triangle extends Shape {
    ...
    render() {
        const innerHtml = `<svg version="1.1"
                                width="300" height="300"
                                xmlns="http://www.w3.org/2000/svg">
                            <polygon points="0 300, 300, 150 0", fill="${this.color}" />
                            <text x="120" y="145" font-size="80" text-anchor="middle" fill="${this.textColor}">${this.text}</text>
                            </svg>`;
        return innerHtml;
    }
}

const triangle = new Triangle('black', 'CAG', 'white');
